...
import SportsNews from './newsScreens/sportsNews';
import Headlines from './newsScreens/headlines';
...
import InternationalNews from './newsScreens/internationalNews';
import News from './newsScreens/news';
import CompleteNews from './newsScreens/completeNews';
...
export default function DashboardLayout() {
    const [routeList, setRouteList] = useState(
        [
            ...
            {
                routeName: "International News",
                route: "internationalNews",
        ...
        <Box sx={{ display: 'flex' }}>
            ...
            <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
               ...
               <Routes>
                    ...
                    <Route path="completeNews" element={<CompleteNews />} />
                </Routes>
